   ...
   <header>
        ...
        <ul id="HelloTask">
	      ...
	      value="Abmelden"/> </form>
	    	...
	    	<nav>
	    		<ul>
	            	<li><a href="UrlaubView.jsp">Urlaubsanträge verwalten</a></li>
	            	<li><a href="UrlaubUpdateView.jsp">Übersicht über Mitarbeiterabwesenheiten</a></li>
	            	<li class="profile-menu">

    ...
    <header id="main-content">
      ...
      <form action="../jsp/UrlaubAppl.jsp" method="get">
    	<table class="styled-table">
			  ...
			  <jsp:getProperty name="myKrank" property="alleUrlaubsantraegeUndKrankmeldungenForHR" />
		</table> <br> <br>
		<input type='submit' name='zurueck13' id="btn" class="btn btn-primary btn-block mb-4" value='Zurück' class="inputlogin">
	   </form>

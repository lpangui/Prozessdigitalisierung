...
<form action="../jsp/AdminAppl.jsp" method="get">
    	<table class="styled-table">
			  ...
			  <jsp:getProperty name="myM" property="alleMeldungen" />
		</table> <br> <br>
		<input type='submit' name='zurueck4' id="btn" class="btn btn-primary btn-block mb-4" value='Zurück' class="inputlogin">
	   </form>
